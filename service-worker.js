const CACHE_NAME = 'radio-premium-cache-v24'; // Force update for icon rendering and sync logic
const urlsToCache = [
  './index.html',
  './manifest.json?v=24',
  './icon.svg',
...
self.addEventListener('install', event => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then(cache => {
        console.log('Opened cache, caching assets for v24.');
