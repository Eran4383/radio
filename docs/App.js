...
import { fetchIsraeliStations } from './services/radioService.js';
...
export default function App() {
  ...
  const [isVisualizerLocked, setIsVisualizerLocked] = useState(() => {
  ...
  const handleSetVisualizerLocked = (locked) => {
